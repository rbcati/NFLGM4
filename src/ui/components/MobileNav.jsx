    ...
    <>
      ...
      >
        {BOTTOM_TABS.map((tab) => {
          ...
          return (
            <button key={tab.id} className={`mobile-bottom-tab premium-bottom-tab ${isActive ? 'active' : ''}`} onClick={onClick} aria-label={tab.label} aria-current={isActive ? 'page' : undefined}>
              <Icon size={20} />
